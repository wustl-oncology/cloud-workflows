...
--analysis-release   DEFAULT 1.5.1. For options, visit: https://github.com/wustl-oncology/analysis-wdls/releases
...
[ -z $ANALYSIS_RELEASE ] && ANALYSIS_RELEASE="1.5.1"
