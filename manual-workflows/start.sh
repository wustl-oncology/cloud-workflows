...
--analysis-release   DEFAULT 1.3.0. For options, visit: https://github.com/wustl-oncology/analysis-wdls/releases
...
[ -z $ANALYSIS_RELEASE ] && ANALYSIS_RELEASE="1.3.0"
